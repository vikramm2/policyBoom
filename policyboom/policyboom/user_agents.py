"""
User-Agent rotation for improved web scraping success rates.

Provides realistic browser user-agents to avoid bot detection.
"""
...
def get_headers(additional_headers: dict | None = None) -> dict:
    ...
    Returns:
        dict: Complete set of HTTP headers
    """
    headers = {
